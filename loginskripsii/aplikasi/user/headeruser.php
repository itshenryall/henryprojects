...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="homeuser.php">Halaman User</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="divider"></li>
            <li><a href="data_nilai.php">Data Nilai Kriteria</a></li>
            <li class="divider"></li>
            <li><a href="perhitungan.php">Perhitungan Nilai</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Tambah Data <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="tambah_nilai.php">Nilai Kriteria</a></li>
          </ul>
        </li>
        <!-- <li class="dropdown"> -->
          ...
          <!-- </ul> -->
        <!-- </li> -->
        <li><a href="hasil.php">Hasil Nilai Akhir</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="data_user.php">Ubah Username / Password</a></li>
            <li class="divider"></li>
