...
<br>
<br><br><br>
     <div class="container"><h2><font style="color:#339966;"><i class="fa fa-archive fa-3x"></i>Informasi Data Alternatif</h2>
...
$sql = mysql_query("SELECT * FROM alternatif");
  ...
  echo "<center><H3>Data Alternatif</H3></center>
  <table border='1' align='center'>
    <tr>
      <th width='50'>No</th>
      <th width='180'>Nama Alternatif</th>
      <th>Deskripsi</th>
